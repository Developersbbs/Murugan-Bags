...
export async function editProduct(
  ...
  const parsedData = productFormSchema.safeParse({
    ...
    fileSize: formData.get("file_size") || undefined,
    downloadFormat: formData.get("download_format") || undefined,
    licenseType: formData.get("license_type") || undefined,
    downloadLimit: formData.get("download_limit") || undefined,
