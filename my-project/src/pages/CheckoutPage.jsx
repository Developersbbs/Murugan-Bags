...
const CheckoutPage = () => {
  ...
  const handleAddressSelect = (address) => {
    if (!address.firstName || !address.lastName) {
      toast.error(
        "This address format is outdated. Please add a new address with complete details.",
      );
      return;
    }
    setFormData((prev) => ({
  ...
  // const tax = subtotal * 0.1; // TAX DISABLED
  const total = subtotal + shipping; // + tax; // TAX DISABLED
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {savedAddresses.length > 0 && !addressesLoading && (
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                {savedAddresses.some(
                  (addr) => !addr.firstName || !addr.lastName,
                ) && (
                  <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <p className="text-sm text-yellow-800">
                        Some of your saved addresses use an older format. Please
                        add new addresses for the best checkout experience.
                      </p>
                    </div>
                  </div>
                )}
                  ...
                  {savedAddresses.map((address) => {
                    ...
                    return (
                      <div
                        ...
                        onClick={() =>
                          !isLegacyAddress && handleAddressSelect(address)
                        }
                      >
                              ...
                              {address.firstName && address.lastName ? (
                                ...
                                <>
                                  ...
                                  <p className="text-xs text-yellow-600 mt-1">
                                    This address uses an old format. Please
                                    update it.
                                  </p>
                                </>
                              )}
                ...
                <div className="flex items-center justify-between">
                  <p className="text-sm text-gray-600">
                    {selectedAddressId
                      ? "Address selected - details shown below"
                      : "Select an address above or add a new one"}
                  </p>
                  {selectedAddressId && (
                    <button
                      type="button"
            ...
            {showAddressForm && (
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                  ...
                  <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <p className="text-sm text-green-800">
                        Address selected and form pre-filled. You can modify
                        details if needed.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="mb-4 p-3 bg-rose-50 border border-rose-200 rounded-lg">
                    <div className="flex items-center">
                      ...
                      <p className="text-sm text-rose-800">
                        Editing address. Update the details below and click
                        "Update Address".
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex items-center">
                  ...
                  <label
                    htmlFor="saveInfo"
                    className={`ml-2 text-sm ${editingAddressId ? "text-gray-400" : "text-gray-700"}`}
                  >
                ...
                {formData.paymentMethod === "cod" && (
                  <div className="ml-7 p-4 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <p className="text-sm text-green-700 mt-1">
                      Pay {formatCurrency(total)} in cash when your order is
                ...
                {formData.paymentMethod === "razorpay" && (
                  <div className="ml-7 p-4 bg-rose-50 border border-rose-200 rounded-lg">
                    ...
                    <p className="text-sm text-rose-700 mt-1">
                      Pay securely with credit card, debit card, UPI, or net
                      banking.
                    </p>
                  </div>
                )}
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sticky top-4">
              ...
              <p className="mt-4 text-center text-sm text-gray-500">
                ...
                <Link to="/#hero" className="text-rose-600 hover:underline">
                  Terms of Service
                </Link>{" "}
                and{" "}
                <Link to="/#hero" className="text-rose-600 hover:underline">
